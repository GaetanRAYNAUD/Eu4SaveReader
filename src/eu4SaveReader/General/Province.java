...
public class Province {
    ...
    private ArrayList<Double> extractInstitutions (String provinceInfos) {
        ...
        ArrayList<Double> institutions = new ArrayList<>();
        ...
        if ((startAddr = provinceInfos.indexOf("institutions={")) != - 1) {
            ...
            for (String anInstitutionsString : institutionsString) {
                institutions.add(Double.parseDouble(anInstitutionsString));
            }
        }
    ...
    private String printInstitutions () {
        ...
        for (int i = 0; i < institutions.size(); i++) {
            ...
            institutionsString.append(": ").append(institutions.get(i)).append("%");
